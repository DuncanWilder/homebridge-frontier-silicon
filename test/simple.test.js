...
describe('Homebridge Frontier Silicon Plugin', () => {
  ...
  describe('HttpAccessory', () => {
    ...
    test('should have required prototype methods', () => {
      ...
      assert.strictEqual(typeof HttpAccessory.prototype.setPowerState, 'function');
      assert.strictEqual(typeof HttpAccessory.prototype.getPowerState, 'function');
      assert.strictEqual(typeof HttpAccessory.prototype.identify, 'function');
      assert.strictEqual(typeof HttpAccessory.prototype.getServices, 'function');
    });
